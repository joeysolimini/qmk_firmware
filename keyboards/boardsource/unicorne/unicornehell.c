...
[_ARROWS] = LAYOUT(
            "_______", "_______", "_______", "KC_UP", "_______", "_______",       "KC_MINS", "KC_EQL", "RGB_SAI", "RGB_MOD",  "RGB_TOG", "_______",
            "_______",  "_______", "KC_LEFT", "KC_DOWN", "KC_RIGHT", "_______",       "KC_GRV", "KC_LCBR", "KC_RCBR", "KC_LBRC", "KC_RBRC", "_______",
            "_______", "_______", "_______", "_______", "_______", "_______",       "KC_BSLS", "KC_LPRN", "KC_RPRN", "KC_LT",  "KC_GT", "_______",
                                            "_______", "_______", "_______",       "_______", "_______", "_______"
)
};
// clang-format on
